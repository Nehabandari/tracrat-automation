...
public class HomePage1 {
    ...
    @FindBy(xpath = "//div[@title='click here to Manage Locations']/ngx-select-dropdown/div/div/button")
    WebElement selectLocation;

    @FindBy(name = "search-text")
    WebElement searchLocationstextfield;

    @FindBy(xpath = "//div[@class='available-items']/div")
    List< WebElement> locationslist;

    @FindBy(xpath = "(//h4)[3]")
    WebElement verifyinglocation;
    ...
    @FindBy(partialLinkText = "Manage Locations")
    WebElement managelocationslink;


    public HomePage1(DriverHelper driverHelper, CompanyDataDetails companyDataDetails){
    ...
    public void clickManagelocationslinkabc(){
        driverHelper.waitForVisible(managelocationslink);
